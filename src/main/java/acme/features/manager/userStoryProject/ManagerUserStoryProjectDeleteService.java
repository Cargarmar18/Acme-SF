/*
 * EmployerWorksForDeleteService.java
 *
...
public class ManagerUserStoryProjectDeleteService extends AbstractService<Manager, UserStoryProject> {
	...
	public void validate(final UserStoryProject object) {
		...
		super.state(object.getUserStory() != null, "userStory", "manager.user-story-project.form.error.noUserStorySpecified");
	...
	public void perform(final UserStoryProject object) {
		assert object != null;
		int userStoryId, projectId;
		projectId = object.getProject().getId();
		userStoryId = object.getUserStory().getId();

		this.repository.deleteUserStoryProject(projectId, userStoryId);
	}
	...
	public void unbind(final UserStoryProject object) {
		...
		userStories = this.repository.findManyAvailableUserStoriesFromProjectByManagerId(managerId, projectId);
